...
#define wait_GDO0_high_test()                                                                \
    {                                                                                        \
        ...
        {                                                                                    \
            ...
            if (abcdefg == 1800)                                                             \
            {                                                                                \
                Serial.print(F("STUCK, marcstate: "));                                       \
                Serial.print(readStatusReg(CC1101_MARCSTATE));                               \
                Serial.print("; gdo2 reg: ");                                                \
                Serial.println(readStatusReg(CC1101_IOCFG2));                                \
                if (extra_packet_waiting)                                                    \
                {                                                                            \
                    Serial.println("Response task failed????");                              \
                }                                                                            \
                if (packetWaiting)                                                           \
                {                                                                            \
                    Serial.println("Traffic generator receive failed????");                  \
                }                                                                            \
                abcdefg = 0;                                                                 \
    ...
    {                                                                 \
        ...
        {                                                             \
            ...
            {                                                         \
                ...
                Serial.println(rfbits);                               \
                s = micros();                                         \
                if (rfbits == 193)                                    \
                {                                                     \
                    Serial.print("OVERFLOW; GDO2 config value: ");    \
                    Serial.println(readConfigReg(CC1101_IOCFG2));     \
                }                                                     \
            }                                                         \
        }                                                             \
    }
