...
/**
 * Possible values for the LENGTH_CONFIG parameter.
 */
#define CC1101_LENGTH_CONFIG_FIXED 0x00
#define CC1101_LENGTH_CONFIG_VARIABLE 0x01
#define CC1101_LENGTH_CONFIG_INFINITE 0x02
...
#define CC1101_DEFVAL_FIFOTHR 0x00  // RX FIFO and TX FIFO Thresholds
...
#define CC1101_DEFVAL_PKTCTRL0 0x06 // Packet Automation Control
...
// Enable monitoring the TX FIFO state through GDO2
...
public:
   ...
   */
  unsigned short receiveData(CCPACKET *packet);
   ...
   */
  void setPacketLengthConfig(int mode);
